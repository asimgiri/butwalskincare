  ...
  <div class="row">
    ...
    <div class="col-sm-8 blog-left">
      <ul class="blog-listing detail">
        <li> <img src="images\blog-detail-img.jpeg" class="img-responsive" alt="">
          <h2>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h2>
          <ul class="post-detail">
            <li><span class="icon-date-icon ico"></span><span class="bold">14 Feb</span> 2019</li>
            <li>Posted By : <span class="bold">Julien</span></li>
      ...
      <div class="comments-wrapper padding-lg">
        ...
        <ul class="row comments">
          <li class="col-sm-12 clearfix">
            <div class="com-img"><img src="images\comment-img1.jpeg" class="img-circle" alt=""></div>
            <div class="com-txt">
              <h3>JASON ANDERSON <span>April 14, 2019 at 13:56</span></h3>
          ...
          <li class="col-xs-offset-1 col-sm-11 clearfix">
            <div class="com-img"><img src="images\comment-img2.jpeg" class="img-circle" alt=""></div>
            <div class="com-txt">
              <h3>Michael <span>April 10, 2019 at 11:40</span></h3>
              <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</p>
              <a href="#"><span class="icon-reply-icon"></span>Reply</a> </div>
          </li>
          <li class="col-sm-12 clearfix">
            <div class="com-img"><img src="images\comment-img3.jpeg" class="img-circle" alt=""></div>
            <div class="com-txt">
              <h3>WILLIAM JACKSON <span>April 6, 2019 at 10:30</span></h3>
              <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</p>
              <a href="#"><span class="icon-reply-icon"></span>Reply</a> </div>
          </li>
        </ul>
        ...
        <div class="recent-post">
          ...
          <ul>
            <li class="clearfix"> <a href="#">
              <div class="img-block"><img src="images\rp-thumb1.jpeg" class="img-responsive" alt=""></div>
              <div class="detail">
                <h4>simply dummy text of the...</h4>
                <p><span class="icon-date-icon ico"></span><span>14 Feb</span> 2019</p>
              </div>
              </a> </li>
            <li class="clearfix"> <a href="#">
              <div class="img-block"><img src="images\rp-thumb2.jpeg" class="img-responsive" alt=""></div>
              <div class="detail">
                <h4>simply dummy text of the...</h4>
                <p><span class="icon-date-icon ico"></span><span>12 Feb</span> 2019</p>
              </div>
              </a> </li>
            <li class="clearfix"> <a href="#">
              <div class="img-block"><img src="images\rp-thumb3.jpeg" class="img-responsive" alt=""></div>
              <div class="detail">
                <h4>simply dummy text of the...</h4>
                <p><span class="icon-date-icon ico"></span><span>08 Feb</span> 2019</p>
              </div>
              </a> </li>
          </ul>
        </div>
